...
public class AppFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		mostSeenLabel.setText("MÃ¡s vistos");
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String nombreLista = JOptionPane.showInputDialog(framePanel, "Â¿Como quieres llamar a la nueva lista?",
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String nombre = JOptionPane.showInputDialog(thisFrame,
						"Â¿Como quieres llamar al archivo pdf de tus videos?", "Mis Videos",
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ControladorMyVideoApp.getUnicaInstancia().isPremium()) {
					...
					if (JOptionPane.showConfirmDialog(thisFrame, "Â¿Seguro que querieres hacerte premium?",
							"Usuario Premium", JOptionPane.YES_NO_OPTION) == 0)
						ControladorMyVideoApp.getUnicaInstancia().doPremium();
					JOptionPane.showMessageDialog(thisFrame, "Â¡Enhorabuena, Ya eres premium!", "Usuario Premium",
							JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
		...
		outButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				if(JOptionPane.showConfirmDialog(thisFrame, "Â¿Seguro que quieres salir?", "Log out", JOptionPane.YES_NO_OPTION) == 0) {
